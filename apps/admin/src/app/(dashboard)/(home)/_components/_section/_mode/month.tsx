...
import { SingleParserBuilder, SetValues } from "nuqs";
import React, {
  SetStateAction,
  Dispatch,
  useCallback,
...
interface MonthModeSection {
  ...
  setQuery: SetValues<{
    modeOrder: Omit<SingleParserBuilder<string>, "parseServerSide"> & {
      readonly defaultValue: string;
      parseServerSide(value: NuqsValue): string;
    };
    from: Omit<SingleParserBuilder<string>, "parseServerSide"> & {
      readonly defaultValue: string;
      parseServerSide(value: NuqsValue): string;
    };
    to: Omit<SingleParserBuilder<string>, "parseServerSide"> & {
      readonly defaultValue: string;
      parseServerSide(value: NuqsValue): string;
    };
  }>;
